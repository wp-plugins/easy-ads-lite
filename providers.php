  ...
  class Overview extends ezOverview {
    ...
    function renderContent() {
      ...
      $instructionText = '<h4>Instructions</h4>' .
              ...
              ezTab::makeLIwithTooltip('Generate Code', 'Generate your ad code from the ad-provider web site.') .
      ...
      $planText = '<h4>Future Plans</h4><ul style="padding-left:10px;list-style-type:circle; list-style-position:inside;" >' .
              ...
              ezTab::makeLIwithTooltip('Ad Rotation', 'I will provide means to rotate ads among various providers with user-defined frequency.') .
              ezTab::makeLIwithTooltip('More Providers', 'This plugin is designed with extensibility in mind. I will keep adding more ad providers, or even let the end-users add them.') .
              ezTab::makeLIwithTooltip('Provider Specificity', 'This initial release treats all ad providers essentially the same way. In the next release, I will start introducing more specificity, like specialized fields for HopID, PubID, colors, etc.') .
              ezTab::makeLIwithTooltip('Expertise Level', 'I plan to introduce expertise levels (Easy, Advanced and Expert tabs) within the tab for each ad provider.') .
              ezTab::makeLIwithTooltip('Max Number of Ad blocks', 'Since some providers require you to limit the number of ad blocks to some policy-driven ceiling, I will expose that option to you.<br />Also to be customized is the number of ads per slot. In this initial release, there are three slots (top, middle and bottom), each of which can take two ad blocks. In a future release, you will have much more customization options.') .
              ezTab::makeLIwithTooltip('Ad Block Customization', 'Right now, all the ad blocks are designed to display the same ad code, for which the providers will serve different text. In a future release, I will give you a means of introducing different texts for different locations, possibly in a tabbed interface.') .
              ezTab::makeLIwithTooltip('Internationalization', 'Future versions will provide MO/PO files for internationalization.') .
              "</ul><br />\n";
      echo '<table width="95%">', "\n";
