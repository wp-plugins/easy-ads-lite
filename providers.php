    ...
    function renderContent()
    {
      ...
      $fetureText = '<h4>Features</h4>' .
        ...
        ezTab::makeLIwithTooltip('Custom Field Control',
          'In Easy Ads, you have more options [through <strong>custom fields</strong>] ' .
          'to control ad blocks in individual posts/pages. Add custom fields with keys ' .
          'like <strong>easy-ads-adsense-top, easy-ads-adsense-middle, ' .
          'easy-ads-adsense-bottom</strong> and with values like <strong>left, right, ' .
        ...
        ezTab::makeLIwithTooltip('CSS Control',
          'All <code>&lt;div&gt;</code>s that Easy Ads creates have the class attribute ' .
          '<code>easy-ads</code>. Furthermore, they have class attributes like ' .
          '<code>easy-ads-adsense-top</code>, <code>easy-ads-clicksor-bottom</code> ' .
          'etc., (ie, <code>easy-ads-provider-position</code>). You can set the style ' .
  ...
  class Admin extends ezAdmin {
    ...
    function renderContent() {
      ...
      $compText = '<h4>Competition</h4>' .
        'The providers supported in Easy Ads may not all be compatible with ' .
      ...
      $adminText = '<h4>Admin Control Panel</h4>' .
        ...
        ezTab::makeLIwithTooltip('Clean Database',
          'This button gives you the option of cleaning all the Easy Ads ' .
      ...
      else $url = '/wp-content/plugins/easy-ads' ;
