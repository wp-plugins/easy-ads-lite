...
if (class_exists("easyAds")) {
  ...
  add_action('admin_notices', create_function('', 'if (substr( $_SERVER["PHP_SELF"], -11 ) == "plugins.php"|| $_GET["page"] == "easy-ads.php") echo \'<div class="error"><p><b><em>Easy Chitika</em></b>: Not Active!</p></div>\';')) ;
}
?>
